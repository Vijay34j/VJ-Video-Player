...
API_ID = int(environ.get('API_ID', '23543053'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002885498430'))
...
LINK_URL = environ.get("LINK_URL", "https://demotechvj.blogspot.com/p/g.html")
